...
public class StockRecord extends UpdatableRecordImpl<StockRecord> implements Record5<String, byte[], Double, Integer, Double> {

    private static final long serialVersionUID = -442569507;
     ...
     */
    public void setReportDate(byte[] value) {
        set(1, value);
    }
     ...
     */
    @Override
    public Row5<String, byte[], Double, Integer, Double> fieldsRow() {
     ...
     */
    @Override
    public Row5<String, byte[], Double, Integer, Double> valuesRow() {
     ...
     */
    @Override
    public StockRecord value2(byte[] value) {
        setReportDate(value);
        return this;
    }
     ...
     */
    @Override
    public StockRecord values(String value1, byte[] value2, Double value3, Integer value4, Double value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public StockRecord(String symbol, byte[] reportDate, Double sharedAverageCost, Integer shares, Double targetPrice) {
        super(Stock.STOCK);
